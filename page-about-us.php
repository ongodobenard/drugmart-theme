...
.ab-btn-gold { background: var(--ab-gold); color: var(--ab-blue-navy); box-shadow: 0 8px 22px rgba(245,166,35,.30); }
...
@media (max-width: 860px) {
  .ab-hero { grid-template-columns: 1fr; padding: 28px; }
  .ab-hero-img-wrap img { height: 220px; }
...
<div class="ab-wrap">
  ...
  <div class="ab-hero">
    ...
    <div>
      ...
      <p class="ab-hero-desc">Kenya's trusted online pharmacy, serving families with quality, affordable, certified medicines. Licensed by the Pharmacy and Poisons Board of Kenya.</p>
    </div>
  </div>
  ...
  <div class="ab-values">
    <div class="ab-values-grid">
      ...
      <div class="ab-value-card">
        <div class="ab-value-icon"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12" y2="16"/></svg></div>
